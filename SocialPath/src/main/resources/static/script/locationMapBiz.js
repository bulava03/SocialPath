document.addEventListener('DOMContentLoaded', function() {
    ...
    // Обробка чекбокса "Дистанційно"
    document.getElementById('remoteWork').addEventListener('change', function() {
        const mapElem1 = document.getElementById('search-container');
        const mapElem2 = document.getElementById('map');
        ...
        if (this.checked) {
            ...
            document.getElementById('address').value = 'Дистанційно';
            document.getElementById('remoteWork').value = true;
        } else {
            // Якщо прибрано "Дистанційно"
            ...
            setTimeout(() => {
                map.invalidateSize();
                let currLat = document.getElementById('latitude').value;
                let currLng = document.getElementById('longitude').value;
    ...
    if (savedAddress != '' && savedAddress !== 'Дистанційно') {
